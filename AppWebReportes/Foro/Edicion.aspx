<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Edicion.aspx.cs" Inherits="AppWebReportes.Foro.Edicion" %>
                    ...
                    <div class="card card-secondary bg-faded">
                        <div class="card-block">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="txtDetalleEdicion">Detalle de la edición</label>
                                        <textarea class="form-control" runat="server" ID="txtDetalleEdicion" placeholder="Ingrese una detalle de la edición que esta realizando" rows="5"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6 offset-md-3 col-sm-12 offset-sm-0">
                                    <div class="form-group">
                                        <asp:Button ID="btnRegistrar" runat="server" Text="Registrar edición" CssClass="btn btn-primary btn-block" OnClick="btnRegistrar_Click"  />
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <%--evento con ajax, por eso el botón es html--%>
                </div>
            </div>
        </div>
    </div>
