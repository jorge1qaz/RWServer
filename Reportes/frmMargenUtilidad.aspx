<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmMargenUtilidad.aspx.cs" Inherits="AppWebReportes.Reportes.frmMargenUtilidad" %>
                        ...
                        <div class="card-block">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="lstTipoMoneda" CssClass="form-control" runat="server">
                                    <asp:ListItem Selected="True" Value="true">Nuevos soles</asp:ListItem>
